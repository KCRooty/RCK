...
import type { InstalledApp, LiveMetrics, PackageManager, ServiceInfo, SystemInfo } from "./types";
...
export const desktop = {
  ...
  getLiveMetrics: () => invoke<LiveMetrics>("get_live_metrics"),
  ...
  uninstallInstalledApp: (uninstallCommand: string) =>
    invoke<string>("uninstall_installed_app", { uninstallCommand }),
};
